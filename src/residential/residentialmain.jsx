    ...
    >
      <div className="relative w-full min-h-screen">
        ...
        <video
          ...
          playsInline
        >
          <source src="./residentialmain.mp4" type="video/mp4" />
          ...
          >
            <div className="container px-4 text-left">
              <div className="space-y-4">
                ...
                >
                  Transform Your Home with Clean, Sustainable Energy
                </motion.p>
                ...
                >
                  Embrace the future of residential energy with our cutting-edge solar solutions. Reduce your carbon footprint and energy bills while increasing your home's value.
                </motion.p>
